...
In Part 4, we discuss improvements to the model and how to determine the model's hyperparameters. In addition, we take a step into deep learning by combining several layers of neurons.
